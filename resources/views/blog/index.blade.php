            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="fs-17 pb-3">Rechercher dans le blog</h3>
                            <div class="divider"><span></span></div>
                            <form method="post" class="pt-4">
                                <div class="form-group mb-0">
                                    <input class="form-control form--control form--control-bg-gray" type="text" name="search" placeholder="Tapez vos mots de recherche...">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="fs-17 pb-3">Catégories</h3>
                            <div class="divider"><span></span></div>
                        ...
                        <div class="card card-item hover-y">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="media media-card align-items-center shadow-none p-0 mb-0 rounded-0 mt-4 bg-transparent">
                                    ...
                                    <div class="media-body">
                                        <h5 class="fs-14 fw-medium">Par <a href="#">{{$item->name}}</a></h5>
