<header class="header-area bg-white border-bottom border-bottom-gray">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-2">
                <div class="logo-box">
                    <a href="index.html" class="logo"><img src="{{ asset('forum/images/logo.png') }}"
                            width='75px' alt="logo"></a>
            ...
            <div class="col-lg-10">
                <div class="menu-wrapper border-left border-left-gray pl-4 justify-content-end">
                    ...
                    <div class="nav-right-button">
                        <a href="{{ route('register') }}" class="btn theme-btn"><i class="la la-user mr-1"></i> Se
                            connecter</a>
