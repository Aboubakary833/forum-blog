...
<section class="hero-area pt-80px pb-50px bg-white shadow-sm">
    ...
    <div class="container">
        <div class="hero-content text-center pb-5">
            <h2 class="section-title pb-3 theme-font-2 fs-40">Votre forum Q&A , Votre Communauté</h2>
            <p class="section-desc">Ce forum de question reponse est conçu pour : <br>
        ...
        <div class="row">
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                ...
                <div class="media-body">
                    <h5 class="fs-18 mb-1 theme-font-2 fw-bold">Posez vos questions</h5>
                    <p class="fs-15 lh-20">Otenez rapidement une reponse </p>
                </div>
            </div><!-- end media -->
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                ...
                <div class="media-body">
                    <h5 class="fs-18 mb-1 theme-font-2 fw-bold">Partager votre Expérience</h5>
                    <p class="fs-15 lh-20">Aider les autres de part vos connaissances</p>
                </div>
            </div><!-- end media -->
            <div class="col-lg-4 media align-items-center pb-30px responsive-column-half">
                ...
                <div class="media-body">
                    <h5 class="fs-18 mb-1 theme-font-2 fw-bold">Soyez actif</h5>
                    <p class="fs-15 lh-20">Etre au service de la communauté</p>
                </div>
            </div><!-- end media -->
        </div><!-- end hero-list -->
    </div><!-- end container -->
