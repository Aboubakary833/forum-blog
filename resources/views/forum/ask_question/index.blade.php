...
@include('forum.components.header')
...
<section class="hero-area bg-white shadow-sm overflow-hidden">
    ...
    <div class="container">
        <div class="hero-content pt-80px pb-80px">
            <h2 class="section-title">Poser votre question</h2>
                ...
                <div class="card card-item">
                    <form method="post" class="card-body">
                        <div class="input-box">
                            ...
                            <p class="fs-13 pb-3 lh-20">Soyez claire et simple dans vos propos</p>
                        ...
                        <div class="input-box">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="fs-13 pb-3 lh-20">Ajoutez jusqu'à 3 tags pour décrire le sujet de votre question :</p>
                                </div>
                            </div>
                            <div class="form-group">
                                <input class="form-control form--control" type="text" name="text" placeholder="e.g.javascript , php , laravel">
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Techno</label>
                            ...
                            <div class="form-group">
                                <select class="select-container select--container" data-placeholder="Select a Category">
                                    <option selected value="">Selectionner une technologie/languange</option>
                        ...
                        <div class="input-box">
                            ...
                            <p class="fs-13 pb-3 lh-20">
                                Incluez toutes les informations dont quelqu'un aurait besoin pour répondre à votre question
                                </p>
                            <div class="form-group">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <div class="file-upload-wrap file-upload-layout-2">
                                    ...
                                    <span class="file-upload-text d-flex align-items-center justify-content-center"><i class="la la-cloud-upload mr-2 fs-24"></i>Televerser une image</span>
                                </div>
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box pt-2">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox fs-13 mb-1">
                                    ...
                                    <label class="custom-control-label custom--control-label" for="notifiedMe">Notifié par email si toutes fois vous avez une reponse.</label>
                                </div>
                            </div>
                            <div class="btn-box">
                                <button type="submit" class="btn theme-btn">Publier la question</button>
                            </div>
                        </div>
                    </form>
                </div><!-- end card -->
                ...
                <div class="sidebar">
                    <div class="card card-item p-4">
                        ...
                        <p class="fs-14 lh-22 pb-2 pt-3">
                            La communauté est là pour vous aider avec des problèmes spécifiques de codage, d'algorithme ou de langage.
                            </p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <button class="btn btn-link collapsed fs-15" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <span><span class="text-color pr-2 fs-16">3.</span> Afficher du code</span>
                                        <i class="la la-angle-down collapse-icon"></i>
                                    </button>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div class="card-body">
                                       <p class="fs-14 lh-22 text-black-50">
                                        Le cas échéant, partagez la quantité minimale de code dont les autres ont besoin pour reproduire votre problème (également appelé
                                           <a href="#" class="text-color hover-underline">minimum</a>, <a href="#" class="text-color hover-underline">exemple reproductible</a>)
                                       </p>
                                    </div>
                                </div>
                            </div><!-- end card -->
