                ...
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        <div class="form-group">
                            <h3 class="fs-22 pb-3 fw-bold">Rejoignez Nous </h3>
                        </div>
                        <div class="form-group">
                            <label class="fs-14 text-black fw-medium lh-18">Nom d'utilisateur</label>
                            <input type="email" name="email" class="form-control form--control" placeholder="Entrer votre nom d'utilisateur">
                        </div><!-- end form-group -->
                        <div class="form-group">
                            <label class="fs-14 text-black fw-medium lh-18">Adresse Email</label>
                            <input type="email" name="email" class="form-control form--control" placeholder="Entrer votre Adresse email">
                        </div><!-- end form-group -->
                        <div class="form-group">
                            ...
                            <p class="fs-13 lh-18">Le mot de passe doit contenir au moins 8 caractères, incluant  au moins une lettre et un nombre</p>
                        </div><!-- end form-group -->

                        <div class="form-group">
                            <button id="send-message-btn" class="btn theme-btn w-100" type="submit">S'inscrire <i class="la la-arrow-right icon ml-1"></i></button>
                        </div><!-- end form-group -->
                        <p class="fs-13 lh-18 pb-3">En cliquant sur “Se connecter”, vous accepté les <a href="terms-and-conditions.html" class="text-color hover-underline">termes et  conditions de confidentialités </a>
                    </div><!-- end form-action-wrapper -->
                </div><!-- end col-lg-5 -->
            </div><!-- end row -->
        </form>
        <p class="text-black text-center fs-15">Avez vous déjà un compte? <a href="{{ route('login') }}" class="text-color hover-underline">Se connecter</a></p>
    </div><!-- end container -->
